...
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/deep1.png)
...
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta1.png)
在表2中，我们报告了每个配置的参数数量。尽管深度很大，我们的网络中权重数量并不大于具有更大卷积层宽度和感受野的较浅网络中的权重数量（144M的权重在（Sermanet等人，2014）中）。

表2：参数数量（百万级别）
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta2.png)
2.3 讨论
...
表3：在单测试尺度的ConvNet性能
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta3.png)
...
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta4.png)
4.3 多裁剪图像评估
...
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta5.png)
4.4 卷积网络融合
...
表6：多个卷积网络融合结果
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta6.png)
4.5 与最新技术比较
...
![Image text](https://github.com/leo-wan7/leo-wan7.github.io/tree/master/img/ta7.png)
